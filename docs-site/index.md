...
features:
  ...
  - title: "Policy Engine -- Deny by Default"
    ...
    icon: "\U0001F6E1\uFE0F"
  - title: "MCP Server"
    details: "Agents interact with the wallet exclusively through the Model Context Protocol (MCP). One call to createMcpServer() exposes all wallet tools to any MCP-compatible AI agent -- Claude, OpenAI, LangChain, or custom. Policy enforcement is transparent."
    icon: "\U0001F916"
